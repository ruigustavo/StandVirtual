...
<form class="w3-form" method="post" action="Main" enctype="multipart/form-data">
    ...
    <div class="w3-input-group">
        <label>Brand</label>
        <input class="w3-input" name="brand" type="text" value = "${car.getBrand()}" required/>
    </div>
    <div class="w3-input-group">
        <label>Model</label>
        <input class="w3-input" name="model" type="text" value = "${car.getModel()}" required/>
    </div>

    <div class="w3-input-group">
        <label>Price</label>
        <input class="w3-input" name="price" type="number" value = "${car.getPrice()}" required/>
    </div>

    <div class="w3-input-group">
        <label>Month</label>
        <input class="w3-input" name="registration_month" type="text" value = "${car.getRegistration_month()}" required/>
    </div>

    <div class="w3-input-group">
        <label>Year</label>
        <input class="w3-input" name="registration_year" type="number" value = "${car.getRegistration_year()}" required/>
    </div>
